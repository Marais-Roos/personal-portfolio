            ...
            <main className="flex flex-col items-center justify-start grow w-full max-w-[calc(100vw-48px)] lg:max-w-[1056px] md:max-w-[738px] gap-24"> 
                ...
                <div className="mt-24 md:mt-32 lg:mt-40 flex flex-col items-center p-6 lg:p-9 bg-background-secondary w-full max-w-full rounded-2xl gap-12 shadow-2xl shadow-black/10 bg-[url(/background_1.png)]"> 
                    ...
                    <div className="flex flex-col md:flex-row items-center w-full gap-6 max-w-full">
                        {/*Image container*/}
                        <div className="max-w-full flex-1 relative w-full aspect-square">
                        ...
                        <div className="flex flex-col gap-5 w-full max-w-full flex-1 relative">
                            ...
                            <div className="absolute -top-20 md:top-[-20] right-[-16]">
                ...
                {/*Services Section*/}
                <div className="flex flex-col md:grid w-full max-w-full gap-6 md:grid-cols-2 grid-rows-5">
                    <div className="flex flex-col justify-start items-start pt-6 pl-6 md:pt-9 md:pl-9 h-min row-span-1">
                        <h2 className="lg:text-6xl text-5xl font-bold">What I bring to the table</h2>
                    </div>
                ...
                {/*About Section*/}
                <div className="p-6 md:p-9 bg-background-secondary w-full rounded-2xl gap-6 shadow-2xl shadow-black/10 flex flex-col md:flex-row items-center max-w-full">
                    {/*Left*/}
                    <div className="flex flex-col gap-5 flex-1">
                        <h2 className="text-5xl font-bold">Hey, I'm Marais Roos</h2>
                        <p className="text-lg lg:text-xl font-base">I'm a creatively chaotic web designer and developer who took the scenic route into tech. With roots in engineering and informatics (plus a brief, mildly traumatic stint in finance and insurance), I've come to appreciate the magic that happens when structure meets imagination.</p>
                        <p className="text-lg lg:text-xl font-base">These days, I focus on designing and building clean, functional websites that balance logic with creativity. I’m at my best when solving problems, simplifying complexity, and adding a little personality to every pixel.</p>
                ...
                <div className="flex flex-col items-center p-6 md:p-9 bg-background-secondary w-full rounded-2xl gap-12 shadow-2xl shadow-black/10 bg-[url(/background_1.png)]">
                    <CTASection/>
                </div>
            </main>
            <Footer/>
