...
export default function Navbar() {
    ...
    return (
        ...
        <div className="fixed z-50 w-full max-w-[calc(100vw-48px)] lg:max-w-[1056px] md:max-w-[738px] flex justify-center lg:justify-start">
            <nav
                // The main container. Max width is set here for md, but full width for mobile.
                className={`
                    top-6 z-50 flex items-center justify-between bg-background-secondary rounded-xl shadow-2xl shadow-black/10 transition-all
